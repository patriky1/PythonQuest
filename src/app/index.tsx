  ...
  return (
    <Screen scroll={false} style={styles.screen}>
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>Aprenda Python em missões curtas, com XP, corações, trilhas e desafios interativos.</Text>
      </View>
      ...
      <AppButton title="Começar jornada" onPress={() => router.replace('/home')} />
    </Screen>
  );
}
